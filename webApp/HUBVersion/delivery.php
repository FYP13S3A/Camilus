...
$db_expect_start = $today . "_" . $s_start_Delivery_Time;
$db_expect_end = $today . "_" . $s_Last_Delivery_Time;
}

if($totalDuration==1)
{
$db_expect_start = $tommorow . "_" . $s_start_Delivery_Time;

//we need add N days

//if local +1 cause it start tommorow
$addDays = $s_Expected_Local_Duration;
$db_expect_end = Date('Y-m-d', strtotime("+$addDays days")) . "_" . $s_Last_Delivery_Time;
}
...
//if local +1 cause it start tommorow
$addDays = $s_Expected_Local_Duration + 1;
$db_expect_end = Date('Y-m-d', strtotime("+$addDays days")) . "_" . $s_Last_Delivery_Time;
}
