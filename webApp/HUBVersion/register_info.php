...
<table width="100%" border="0">
  ...
  <tr>
    <td width="10%"><label class="frmItemName">&nbsp;Country:</label></td>
    <td width="33%"><select name="s_Country" >
...
?>
  ...
  <tr>
    ...
    <td><input type="text" name="s_City" id="s_City" size="30" value=""></td>
  </tr>
  <tr>
    <td><label class="frmItemName">&nbsp;Postal Code:</label></td>
    <td><input type="text" name="s_Postal" id="s_Postal" size="30" value=""></td>
  </tr>
  </table></td>
    <td>&nbsp;</td>
    <td><table class="registerMail_P1">
  ...
  <tr>
    <td width="19%"><label class="frmItemName">&nbsp;Country:</label></td>
    <td width="33%"><select name="r_Country">
<?php
foreach($result_array AS $row)
{
if($row[NAME]=="Singapore")
...
?>
  ...
  <tr>
    <td><label class="frmItemName">&nbsp;City:</label></td>
    <td><input type="text" name="r_City" id="r_City" size="30" value=""></td>
  </tr>
  <tr>
    <td><label class="frmItemName">&nbsp;Postal Code:</label></td>
    <td><input type="text" name="r_Postal" id="r_Postal" size="30" value=""></td>
  </tr>
  </table></td>
  </tr>
  <tr>
