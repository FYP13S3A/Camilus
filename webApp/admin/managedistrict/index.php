...
?>
 ...
 <?php
$sql = "SELECT * FROM  `district` ORDER BY  `Zone_Id` ASC ";
...
$sql2 = "SELECT * FROM  `district` ORDER BY  `Zone_Id` ASC $limit";
...
echo "<table width='90%' id='dbDataGrid'>";

echo "<tr bgcolor='#CCCCCC' border>";
echo "<td><label class=\"frmItemName\">&nbsp;District Id</label></td>";
echo "<td><label class=\"frmItemName\">&nbsp;Zone Id</label></td>";
echo "<td><label class=\"frmItemName\">&nbsp;Postal Sector</label></td>";
...
while($res=mysql_fetch_array($result2)){
	...
	echo "<td><a href=\"edit.php?id=$res[District_Id]\"><img src=\"../../_images/icon-edit.png \"></img>Edit</a> | <a href=\"delete.php?id=$res[District_Id]\"><img src=\"../../_images/icon-delete.png \"></img>Delete</a></td>";
	$row_count++;
