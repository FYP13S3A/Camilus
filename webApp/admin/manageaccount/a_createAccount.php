...
$sql = "SELECT * FROM building order by Building_Code ASC";
...
if($checkMsg=="1")
{
$systemMsg = "<font color=red size=2>System: <b>Successfully create account.</b></font>";
}
if($checkMsg=="0")
{
$systemMsg = "<font color=red size=2>System: <b>Fail to create account.</b></font>";
}
?>
  ...
  <tr>
    ...
    <input type="hidden" name="mode" value="<?php echo $mode; ?>"/>
      ...
      <table width="56%" height="343" border="0">
        ...
        <tr>
          <td width="52%"><label class="frmItemName">Full Name :</label></td>
          <td width="48%"><input type="text" name="a_Fullname"  size="40" value=""></td>
        </tr>
        <tr>
          <td width="52%"><label class="frmItemName">Email :</label></td>
          <td width="48%"><input type="text" name="a_Email"  size="40" value=""></td>
        </tr>
        <tr>
          <td><label class="frmItemName">Password :</label></td>
          <td><input name="a_Password" type="password" value="" size="40">          
            </tr>
                <tr>
          <td><span class="frmItemName">
            <label class="frmItemName">Work Location :</label></span></td>
