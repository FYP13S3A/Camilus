...
$sql = 'SELECT * FROM accounttype ORDER BY '.$orderBy;
...
$sql2 = 'SELECT * FROM accounttype ORDER BY '.$orderBy.' '.$limit;
...
{ echo "<th scope=\"col\" width=\"9%\"><a href=\"index.php?order=id_desc&pg=$pg\"><label class=\"frmItemName\">Type Id</label><img src=\"../../_images/icon-arrowUp.png\" alt=\"Ascending\" width=\"16\" height=\"19\" /></a>"; }
elseif($_GET['order'] == 'id_desc')
{ echo "<th scope=\"col\" width=\"9%\"><a href=\"index.php?order=id_asc&pg=$pg\"><label class=\"frmItemName\">Type Id</label><img src=\"../../_images/icon-arrowDown.png\" alt=\"Descending Order\" width=\"16\" height=\"19\"/></a>"; }
else
{ echo "<th scope=\"col\" width=\"9%\"><a href=\"index.php?order=id_asc&pg=$pg\"><label class=\"frmItemName\">Type Id</label></a>";  }
echo "</th>";
...
if($_GET['order'] == 'prefix_asc')
{ echo "<th scope=\"col\" width=\"7%\"><a href=\"index.php?order=prefix_desc&pg=$pg\"><label class=\"frmItemName\">Prefix</label><img src=\"../../_images/icon-arrowUp.png\" alt=\"Ascending\" width=\"16\" height=\"19\" /></a>"; }
elseif($_GET['order'] == 'lprefix_desc')
{ echo "<th scope=\"col\" width=\"7%\"><a href=\"index.php?order=prefix_asc&pg=$pg\"><label class=\"frmItemName\">Prefix</label><img src=\"../../_images/icon-arrowDown.png\" alt=\"Descending Order\"  width=\"16\" height=\"19\"/></a>"; }
else
{ echo "<th scope=\"col\" width=\"7%\"><a href=\"index.php?order=prefix_asc&pg=$pg\"><label class=\"frmItemName\">Prefix</label></a>";  }
echo "</th>";


echo "<th scope=\"col\" width=\"25%\"><label class=\"frmItemName\">Description</label>"; 
echo "</th>";
...
while($res=mysql_fetch_array($result2)){
	...
	echo "<td>".$res['Type_Id']."</td>";
	echo "<td>".$res['Name']."</td>";
	echo "<td>".$res['Prefix']."</td>";	
	echo "<td>".$res['Description']."</td>";	

	
	echo "<td><a href=\"manage.php?id=".$res['Type_Id']."\"><img src=\"../../_images/icon-edit.png\"></img>Edit</a> | <a href=\"handler.php?id=".$res['Type_Id']."\"><img src=\"../../_images/icon-delete.png\"></img>Delete</a></td>";
