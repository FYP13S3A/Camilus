...
if(!isset($_GET['order'])) {
     $_GET['order'] = 'buildingtype_asc';
	  $order='buildingtype_asc';
	  $orderBy = 'Building_Type_Id ASC';
}
...
switch($_GET['order']) {
	 ...
	 case 'buildingtype_desc':
     $orderBy = "Building_Type_Id DESC";
	 $order='buildingtype_desc';
     break;
...
$sql = 'SELECT * FROM buildingtype ORDER BY '.$orderBy;
...
$sql2 = 'SELECT * FROM buildingtype ORDER BY '.$orderBy.' '.$limit;
...
if($_GET['order'] == 'buildingtype_asc')
{ echo "<th scope=\"col\" width=\"9%\"><a href=\"index.php?order=buildingtype_desc&pg=$pg\"><label class=\"frmItemName\">Type Id</label><img src=\"../../_images/icon-arrowUp.png\" alt=\"Ascending\" width=\"16\" height=\"19\" /></a>"; }
elseif($_GET['order'] == 'buildingtype_desc')
{ echo "<th scope=\"col\" width=\"9%\"><a href=\"index.php?order=buildingtype_asc&pg=$pg\"><label class=\"frmItemName\">Type Id</label><img src=\"../../_images/icon-arrowDown.png\" alt=\"Descending Order\" width=\"16\" height=\"19\"/></a>"; }
else
{ echo "<th scope=\"col\" width=\"9%\"><a href=\"index.php?order=buildingtype_asc&pg=$pg\"><label class=\"frmItemName\">Type Id</label></a>";  }
echo "</th>";
...
while($res=mysql_fetch_array($result2)){
	...
	echo "<td>".$res['Building_Type_Id']."</td>";
	echo "<td>".$res['Name']."</td>";
	
	echo "<td><a href=\"manage.php?id=".$res['Building_Type_Id']."\"><img src=\"../../_images/icon-edit.png\"></img>Edit</a> | <a href=\"handler.php?id=".$res['Building_Type_Id']."\"><img src=\"../../_images/icon-delete.png\"></img>Delete</a></td>";
