...
jQuery(document).ready(function($) {
    ...
    radio.change(function(e) {
        ...
        if (choice === 'yes') {
            form.attr('action', 'appointment.php');
        } else {
            form.attr('action', 'register_info4.php');
        }
    });
});
</script>
...
?>
  ...
  <tr>
    <td colspan="3">
<?php 
if($s_Service=="3" || $s_Service=="2")
{
echo '<b>Would you like to make an appointment for collection ? <input type="radio" name="collection" value="yes">Yes <input type="radio" name="collection" value="no" checked>No</b>';
} 
?>
</td>
  </tr>
